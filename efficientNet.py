...
dir_name = 'MODEL/efficientnetBo_model_'
...
efficientnetBo  = tf.keras.applications.efficientnet.EfficientNetB0(weights=None, include_top=False,
                    input_tensor=inputImage, input_shape=input_shape)

X = efficientnetBo.output 
